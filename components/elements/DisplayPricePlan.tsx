...
export function DisplayPricePlan({ plan, price, description, buttonLabel, benefits }: PricePlan) {
    return (
        <section
            ...
            <p
                className="relative mt-5 flex text-3xl tracking-tight text-gray-900"
            >${price}
            </p>
            <p
            ...
            <a className="inline-flex justify-center rounded-lg py-2 px-3 text-sm font-semibold outline-2 outline-offset-2 transition-colors bg-gray-800 text-white hover:bg-gray-900 active:bg-gray-800 active:text-white/80 mt-6" aria-label="Get started with the Starter plan for [object Object]" href="/register">{buttonLabel}</a>
        </section>
    )
}